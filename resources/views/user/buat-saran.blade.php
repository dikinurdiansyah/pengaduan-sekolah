...
<body class="bg-gray-50 min-h-screen pb-20">
    <div class="bg-white border-b border-gray-200 px-6 py-4">
        <div class="flex items-center">
            ...
            <h1 class="text-lg font-bold text-gray-900">Buat Saran</h1>
        </div>
    </div>

    <div class="p-6">
        <form method="POST" action="/user/saran" class="space-y-4">
            @csrf
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Judul Saran</label>
                <input type="text" name="judul" placeholder="Contoh: Perbaikan kantin sekolah" required
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="4" placeholder="Jelaskan saran Anda secara detail..." required
