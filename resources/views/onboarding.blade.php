...
<body class="bg-gray-50 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-3xl shadow-2xl max-w-md w-full overflow-hidden">
        ...
        <div class="px-8 pb-10 text-center">
            <h1 class="text-2xl font-extrabold text-gray-900 mb-3 leading-tight">Suara Anda, Perubahan<br>untuk Sekolah</h1>
            <p class="text-gray-500 text-sm mb-8 leading-relaxed px-2">Sampaikan pengaduan atau saran dengan mudah, cepat, dan aman.</p>
            ...
            <div class="space-y-3">
                <a href="/login" class="block w-full bg-blue-600 text-white font-semibold py-3.5 rounded-full shadow-lg hover:bg-blue-700 transition">Selanjutnya</a>
                <a href="/login" class="block w-full text-gray-500 font-medium py-2 hover:text-gray-700 text-sm">Lewati</a>
            </div>
        </div>
    </div>
</body>
